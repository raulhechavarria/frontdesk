...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.application.domain.Customer.class.getName() + ".yards", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Yard.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Customer.class.getName() + ".hs", jcacheConfiguration);
